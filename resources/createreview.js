...
function updateFilters(add_reviewer)
{
  var content;
  if (add_reviewer)
    content = $("<div class='comment' title='Add Reviewer'>"
              +   "<p>Make specified users reviewers of given path during this review.</p>"
              +   "<p>"
              +     "<b>User name(s):</b><br>"
    ...
    content = $("<div class='comment' title='Add Watcher'>"
              +   "<p>Make specified users watchers of given path during this review.  "
